...
namespace log4cplus
{
    ...
    public:
         ...
         * log4cplus.appender.A1=SyslogAppender
         *
         ...
         * log4cplus.appender.A1.layout=PatternLayout
         ...
         * log4cplus.appender.A2=RollingFileAppender
         * log4cplus.appender.A2.MaxFileSize=10MB
         * log4cplus.appender.A2.MaxBackupIndex=1
         * log4cplus.appender.A2.layout=TTCCLayout
