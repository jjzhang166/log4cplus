...
namespace log4cplus {
    ...
    namespace helpers
    {
         ...
         * Linux ipchains. 
         */
        class LOG4CPLUS_EXPORT Filter : public virtual helpers::SharedObject 
        {
        public:
          // ctor and dtor
            Filter();
        ...
        public:
            DenyAllFilter ();
            DenyAllFilter (const helpers::Properties&);
        ...
        public:
            LogLevelMatchFilter();
            LogLevelMatchFilter(const helpers::Properties& p);
        ...
        public:
          // ctors
            LogLevelRangeFilter();
            LogLevelRangeFilter(const helpers::Properties& p);
