...
namespace log4cplus {
     ...
     * <b>"%-5p"</b> means the LogLevel of the logging loggingEvent should be left
     ...
     *   E.g. <tt>main.cpp</tt> from path <tt>../../main.cpp</tt>.</td>
     * </tr>
     *
     * <tr>
     *   <td align=center><b>c</b></td>
     * 
     *   <td>Used to output the logger of the logging loggingEvent. The
     ...
     *
     *   <td>Used to output the date of the logging loggingEvent in <b>UTC</b>. 
     *
     ...
     *   <td align=center><b>D</b></td> 
     *
     *   <td>Used to output the date of the logging loggingEvent in <b>local</b> time.
     *
     ...
     *   <td>Used to output the LogLevel of the logging loggingEvent.</td>
     * </tr>
     *
     * <tr>
     *   <td align=center><b>r</b></td>
     *   <td>Used to output miliseconds since program start
     *   of the logging loggingEvent.</td>
     * </tr>
     * 
     * <tr>
     ...
     *   the logging loggingEvent. (This is either `pthread_t` value returned
     ...
     *   with the thread that generated the logging loggingEvent.
     *   </td>     
     * </tr>
     *
     * <tr>
     ...
     *   loggingEvent. It takes optional key parameter. Without the key
    ...
    protected:
        void init(const std::string& pattern, unsigned ndcMaxDepth = 0);
